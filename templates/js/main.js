        ...
        trainingCards.innerHTML += `
          <div class="training-card card">
            <div class="card-header text-center">
              <h3><i class="fas fa-layer-group"></i> <span>${Classname}</span></h3>
            </div>
            <div class="card-body text-center">
              <p>Hình ảnh: <span id="images-${identity}">0</span></p>
              <button class="btn btn-accent btn-shadow btn-lg mt-2" id="${identity}">Thêm hình <i class="fas fa-plus fa-1x"></i></button>
            </div>
          </div>
        `;
